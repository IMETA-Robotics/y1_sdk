...
class Y1SDKInterface {
 public:
  ...
  /**
   * @brief catch joint info at master mode.
   */
  void CatchGripperJointInfo(const std::vector<double> &joints_position,
                             const std::vector<double> &joints_velocity,
                             const std::vector<double> &joints_effort);
