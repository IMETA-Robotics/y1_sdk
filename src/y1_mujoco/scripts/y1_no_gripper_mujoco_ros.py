...
class Mujoco_Model():
    def __init__(self):
        ...
        package_path = subprocess.check_output('rospack find y1_description', shell=True).strip().decode('utf-8')
        model_path = os.path.join(package_path, 'mujoco_model', 'y1_no_gripper_description.xml')
